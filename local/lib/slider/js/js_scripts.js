$.tabs = function(selector, start) {
    ...
    if (!start) { start = $(selector + ':first').attr('rel'); }
...
//var ConstJS = JSON.parse( {"constants":{"TAGS_CLOUD":"&lt;tags&gt;&lt;a href=&quot;.\/tags\/49\/&quot; style=&quot;font-weigth:bold; font-size:10px;&quot;&gt;49&lt;\/a&gt; &lt;a href=&quot;.\/tags\/51\/&quot; style=&quot;font-weigth:bold; font-size:10px;&quot;&gt;51&lt;\/a&gt; &lt;a href=&quot;.\/tags\/53\/&quot; style=&quot;font-weigth:bold; font-size:10px;&quot;&gt;53&lt;\/a&gt; &lt;a href=&quot;.\/tags\/57\/&quot; style=&quot;font-weigth:bold; font-size:10px;&quot;&gt;57&lt;\/a&gt; &lt;a href=&quot;.\/tags\/65\/&quot; style=&quot;font-weigth:bold; font-size:10px;&quot;&gt;65&lt;\/a&gt; &lt;a href=&quot;.\/tags\/66\/&quot; style=&quot;font-weigth:bold; font-size:10px;&quot;&gt;66&lt;\/a&gt; &lt;a href=&quot;.\/tags\/69\/&quot; style=&quot;font-weigth:bold; font-size:10px;&quot;&gt;69&lt;\/a&gt; &lt;\/tags&gt;","CONF_SCROLL_HITS":1,"CONF_HITS_FRIQ":5000,"CONF_HITS_SPEED":1000,"REVIEW_SAVED":0,"ERROR_INPUT_NAME":"\u041f\u043e\u0436\u0430\u043b\u0443\u0439\u0441\u0442\u0430, \u0432\u0432\u0435\u0434\u0438\u0442\u0435 \u0412\u0430\u0448\u0438 \u0424\u0418\u041e","ERROR_INPUT_EMAIL":"\u041f\u043e\u0436\u0430\u043b\u0443\u0439\u0441\u0442\u0430, \u0432\u0432\u0435\u0434\u0438\u0442\u0435 email","ERROR_INPUT_PHONE":"\u041f\u043e\u0436\u0430\u043b\u0443\u0439\u0441\u0442\u0430, \u0432\u0432\u0435\u0434\u0438\u0442\u0435 \u043d\u043e\u043c\u0435\u0440 \u0442\u0435\u043b\u0435\u0444\u043e\u043d\u0430","QUESTION_UNSUBSCRIBE":"\u0423\u0434\u0430\u043b\u0438\u0442\u044c?","PAGE_LANG":"ru"}});
...
function checkname() {
    ...
    if (filter.test(str)) {
        ...
        document.getElementById('name_pic').style.visibility = "visible";
    } else {
        document.getElementById('name_pic').style.visibility = "hidden";
...
function checksurname() {
    ...
    var filter = /^[А-ЯA-Z]{2,}( +)?([А-ЯA-Z]{2,})?( +)?$/i;
    if (filter.test(str)) {
        document.getElementById('surname_div').style.visibility = "hidden";
        document.getElementById('surname_pic').style.visibility = "visible";
    } else {
        document.getElementById('surname_pic').style.visibility = "hidden";
        document.getElementById('surname_div').style.visibility = "visible";
    }
}
...
function checkmail() {
    ...
    if (filter.test(str)) {
        document.getElementById('mail_div').style.visibility = "hidden";
        document.getElementById('mail_pic').style.visibility = "visible";
    } else {
        document.getElementById('mail_pic').style.visibility = "hidden";
...
function checkphone() {
    ...
    if (str != "") {
        ...
        document.getElementById('phone_pic').style.visibility = "visible";
    } else {
...
function moduleSearch() { location = "./index.php?searchstring=" + $('#mod_search_searchword').attr('value'); }
    ...
    for (var i = 0; i < array_input.length; i++) {
        if ((array_input[i].name.split('_')[1]) == 'instock') {
            ...
            if ((Math.round(array_input[i].value * 100) / 100) < (Math.round(document.getElementById('count_' + id).value * 100) / 100)) {
                alert('Перевышено максимально возможное количество для ' + document.getElementById('name' + id).innerHTML);
                return false;
...
$(document).ready(function() {
    ...
    function showSlide() { curSlide = "#slide" + x; if (x == 0) { prevSlide = "#slide" + (i - 1); } else { prevSlide = "#slide" + (x - 1); }
        $(prevSlide).fadeOut(fadeTime, function() { $(curSlide).fadeIn(fadeTime); if (x == (i - 1)) { x = 0; } else { x++; } });
