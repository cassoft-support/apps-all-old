$(document).ready(function() {
    ...
    $.ajaxSetup({
        ...
        error: function(jqXHR, textStatus, errorThrown) {
            ...
            } else if (jqXHR.status == 403) {} else if (jqXHR.status == 500) {
    ...
    $(document).on('change', '.modal-form-filter input', function(e) {
        ...
        if ($(this).val() != "null") {
            ...
            $.ajax({
                type: "POST",
                url: url_path + "systems/ajax/ads.php",
                data: "id_filter=" + id_filter + "&id_item=" + id_item + "&view=modal&action=load_items_filter",
                dataType: "html",
                cache: false,
    ...
    $(document).on('click', '.action-user-route-back', function(e) {
        ...
        $.ajax({
            ...
            url: url_path + "systems/ajax/ads.php",
            dataType: "html",
            data: "action=mobile_user_step_route",
            cache: false,
            success: function(data) {
                location.href = data;
            }
    ...
    $(document).on('click', '.toggle-favorite', function() {
        ...
        $.ajax({
            ...
            data: "id_ad=" + _this.data("id") + "&action=favorite",
            dataType: "json",
            cache: false,
            success: function(data) {
    ...
    $(document).on('input click', '.sticky-search-geo-input', function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                } else { $('.sticky-search-geo-results').html("").hide() }
            }
        });
    });
    ...
    $(document).on('click', '.ads-cat-pay-publication', function() {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/ads.php",
            data: "id_ad=" + $(this).data("id") + "&action=pay_category_publication",
            dataType: "json",
            cache: false,
            success: function(data) {
                if (data["status"] == true) {
    ...
    $(document).on('click', '.buy-payment-goods', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/ads.php",
            data: "id=" + id + "&action=buy_payment_goods",
            dataType: "json",
            cache: false,
            success: function(data) {
                if (data["status"] == true) {
    ...
    $(document).on('click', '.confirm-transfer-goods', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/ads.php",
            data: "id=" + id + "&action=confirm_transfer_goods",
            dataType: "html",
            cache: false,
            success: function(data) {
                location.reload();
    ...
    $(document).on('click', '.confirm-receive-goods', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/ads.php",
            data: "id=" + id + "&action=confirm_receive_goods",
            dataType: "html",
            cache: false,
            success: function(data) {
                location.reload();
    ...
    $(document).on('click', '.confirm-cancel-order', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/ads.php",
            data: "id=" + id + "&action=order_cancel_deal",
            dataType: "html",
            cache: false,
            success: function(data) {
                location.reload();
    ...
    $(document).on('submit', '.form-review-message', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/profile.php",
            data: $(this).serialize() + "&action=add_review",
            dataType: "json",
            cache: false,
            success: function(data) {
                if (data["status"] == true) {
    ...
    $(document).on('submit', '.feedback', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/ads.php",
            data: $(this).serialize() + "&action=feedback",
            dataType: "json",
            cache: false,
            success: function(data) {
                if (data["status"] == true) {
    ...
    $(document).on('submit', '.form-user-subscribe', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/ads.php",
            data: $(this).serialize() + "&action=user_subscribe",
            dataType: "json",
            cache: false,
            success: function(data) {
                if (data["status"] == true) {
    ...
    $(document).on('click', '.modal-ads-subscriptions-add', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/ads.php",
            data: $(".modal-ads-subscriptions-form").serialize() + "&action=modal_ads_subscriptions_add",
            dataType: "json",
            cache: false,
            success: function(data) {
                if (data["status"] == true) {
    ...
    $(document).on('click', '.catalog-ads-subscriptions-add', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/ads.php",
            data: $(".modal-ads-subscriptions-form").serialize() + "&action=catalog_ads_subscriptions_add",
            dataType: "json",
            cache: false,
            success: function(data) {
                if (data["status"] == true) {
    ...
    $(document).on('click', '.site-color-change', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/ads.php",
            data: "color=" + $(this).data("color") + "&action=site_color",
            dataType: "html",
            cache: false,
            success: function(data) {
                location.reload();
    ...
    $(document).on('click', '.modal-edit-site-menu-save', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/admin.php",
            data: $(".modal-edit-site-menu-form").serialize() + "&action=save_menu",
            dataType: "html",
            cache: false,
            success: function(data) {
                location.reload();
    ...
    $(document).on('click', '.mobile-fixed-menu_link-category', function(e) {
        ...
        if ($(this).data('parent')) {
            ...
            $.ajax({
                type: "POST",
                url: url_path + "systems/ajax/ads.php",
                data: "id=" + $(this).data('id') + "&action=mobile_menu_load_category",
                dataType: "html",
                cache: false,
                success: function(data) {
    ...
    $(document).on('change', '.modal-filter-select-category', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/ads.php",
            data: "id=" + $(this).val() + "&action=mobile_menu_load_subcategory",
            dataType: "json",
            cache: false,
            success: function(data) {
    ...
    $(document).on('click', '.modal-search-geo-results .item-city', function() {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/geo.php",
            data: "city_id=" + $(this).attr("id-city") + "&region_id=" + $(this).attr("id-region") + "&country_id=" + $(this).attr("id-country") + "&action=mobile_menu_load_geo",
            dataType: "html",
            cache: false,
            success: function(data) {
    ...
    $(document).on('submit', '.modal-form-filter', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/ads.php",
            data: formFilter() + "&action=load_filters_ads",
            dataType: "json",
            cache: false,
            success: function(data) {
    ...
    $(document).on('submit', '.modal-complaint-form', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/ads.php",
            data: $(this).serialize() + "&action=complaint",
            dataType: "json",
            cache: false,
            success: function(data) {
    ...
    $(document).on('click', '.user-tariff-box-item', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/profile.php",
            data: $('.settings-tariff-form').serialize() + "&action=change_services_tariff",
            dataType: "json",
            cache: false,
            success: function(data) {
    ...
    $(document).on('click', '.settings-tariff-sidebar-calc-activate', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/profile.php",
            data: "tariff_id=" + $('input[name=tariff_id]').val() + "&action=activate_services_tariff",
            dataType: "json",
            cache: false,
            success: function(data) {
    ...
    $(document).on('click', '.profile-tariff-activate', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/profile.php",
            data: "tariff_id=" + el.data('id') + "&action=activate_services_tariff",
            dataType: "json",
            cache: false,
            success: function(data) {
    ...
    $(document).on('click', '.settings-tariff-delete', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/profile.php",
            data: "action=delete_services_tariff",
            dataType: "html",
            cache: false,
            success: function(data) {
