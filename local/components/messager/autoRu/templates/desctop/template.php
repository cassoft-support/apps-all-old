...
$resObject = $arParams['message']['offers'][0]['externalId'];
    ...
    $mess = $arParams['message']['chats'][0]['messages'][0]['content']['text'] . "обращение по объекту
...
// 'last_name'=> $arParams['message']['users'][0][''],//Фамилия
            ...
            'picture' =>
                array(
                    'url' => $arParams['message']['users'][0]['avatar']['images']['big'],//Ссылка на аватарку пользователя, доступную для портала
                ),
