...
<!-- форма фильтр -->
<div class="filter_conteiner" style="display: none;">
    <div class="filter_block">
        <div class="filter_block_title"> Заявки</div>
            ...
            <div class="filter_column">
                ...
                <div class="filter-item filter-input__switcher" data-id="CS_ASSIGNED_BY" id="userObjects"
                    ...
                    <div class="input-radio__item">
                        <input class="input-radio" name="CS_ASSIGNED_BY" type="checkbox" id="CS_ASSIGNED_BY"
                               data-value="Да" checked="">
                        <label class="block-title-text" for="CS_ASSIGNED_BY">Мои заявки</label>
                    </div>
                </div>
        ...
        <div class="slider-btn-group-top" style="">
...
<!--<div id="slider_card" class="slider-card-row" style=""></div>-->
<div id="slider_card" class="slider-card-row" style="display: none;"></div>
<div id="resTable" style="background: #fff!important; padding: 10px;">

</div>
<!--<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js"></script>-->
<script src="https://city.brokci.ru/local/lib/js/moment.min.js"></script>
...
<script type="text/javascript" src="/local/components/logistics/applications/js/script-tab.js?141110"></script>
