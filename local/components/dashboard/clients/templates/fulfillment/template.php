...
<div class="main-block">
    <div class="input-block">
        ...
        <input type="text" id="resCode" name="resCode" hidden value='<?= $arResult['resCode'] ?>'>
...
<?php if($arResult['member_id']){?>
    <script  src="//api.bitrix24.com/api/v1/"></script>
<?php }?>

<script defer src="/local/components/dashboard/main_app/templates/fulfillment/script.js"></script>
