...
<div class="main-block" id="workarea">
    <div class="input-block">
        ...
        <input type="text" id="deal_id" name="user_id" hidden value='<?= $arResult['deal_id'] ?>'>
        <input type="text" id="UserAut" name="UserAut" hidden value='<?= htmlspecialchars($arResult['UserAut']) ?>'>
        <input type="text" id="apps" name="apps" hidden value='stayproperty'>
...
<!--                <li><a href="#" class="click" value="charts">Главная</a></li>-->
                <?php
                  //  if ($arResult['admin'] === 'Y') { ?>
                        ...
                        <li><a href="#" class="click" value="portfolio">Портфолио</a></li>
                        <li><a href="#" class="click" value="favorites">Избранные</a></li>
                    ...
                    <ul>
                        ...
                        <?php
                            if ($arResult['userFIO'] === 'Черкасов') {
                                ...
                                <li><a href="#" class="click" value="stageApps">Стадии избранных</a></li>
...
<script defer src="/local/components/dashboard/main_app/templates/stayproperty/script.js"></script>
