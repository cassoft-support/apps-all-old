...
<div class="main-block">
    ...
    <input type="text" id="app" name="app" hidden value='brokci'>
    <input type="text" id="member_id" name="member_id" hidden value='<?php echo $arResult['member_id'] ?>'>
    <input type="text" id="domain" name="member_id" hidden value='<?php echo $arResult['domain'] ?>'>
...
<!--                    <li><a href="#" class="click" value="objectPars">Парсер</a></li>-->
                ...
                <?php
                    if ($arResult['userFIO'] === 'Черкасов' || $arResult['userFIO'] ==='CAS-soft' || $arResult['userFIO'] ==='Герлинг' || $arResult['userFIO'] ==='Тех.поддержка') { ?>
                        <li><a href="#" class="click" value="messager">Рассылка сообщений</a></li>
            <?php
            }
