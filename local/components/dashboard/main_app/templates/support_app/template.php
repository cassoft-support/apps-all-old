...
<div class="main-block">
    <div class="input-block">
        ...
        <input type="text" id="apps" name="apps" hidden value='support_app'>
            ...
            <ul id="menu">
                ...
                <?php
                    if ($arResult['admin'] === 'Y') { ?>
                        ...
                        <li><a href="#" class="click" value="transfer">Перенос в облако</a></li>
...
<script defer src="/local/components/dashboard/main_app/templates/support_app/script.js"></script>
