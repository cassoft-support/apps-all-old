...
<div class="layout has-sidebar fixed-sidebar fixed-header">
    <div class="input-block">
        ...
        <input type="hidden" id="appCode"  hidden value='hr_pro'>
                        ...
                        <li class="menu-item sub-menu">
                            ...
                            <div class="sub-menu-list">
                                <ul>
                                    ...
                                    <li class="menu-item">
                                        <a href="#" class="click" value="stageVacancy">
                                            <span class="menu-title">Настройки стадий вакансий</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="#" class="click" value="loadingHH">
                                            <span class="menu-title">Импорт с HH</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
        ...
        <main class="content">
            ...
            <footer class="footer">
                <small style="margin-bottom: 20px; display: inline-block">
                    ...
                    ©  <?php echo date("Y"); ?> разработка компании
...
<script defer src="/local/components/dashboard/main_app/templates/hr_pro/script.js?1238"></script>
<script>
    <?= $arResult['chatBuy']?>
