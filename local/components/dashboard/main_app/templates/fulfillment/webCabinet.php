...
<link rel="stylesheet" href="/local/lib/css/new/table.css">
...
<!--        <input type="text" id="UserAut" name="UserAut" hidden value='--><?php //= $arResult['UserAut'] ?><!--'>-->
        <input type="text" id="placement" name="placement" hidden value='<?= $arResult['PLACEMENT'] ?>'>
        <input type="text" id="app" name="app" hidden value='fulfillment'>
            ...
            <div class="sidebar-content">
                <nav class="menu open-current-submenu">
                    <ul>
                        ...
                        <li class="menu-item ">
                            <a href="#" class="click" value="applications">
                        ...
                        <li class="menu-item ">
                            <a href="#" class="click" value="product">
                        ...
                        <li class="menu-item ">
                            <a href="#" class="click" value="product">
                                <span class="menu-icon"><i class="ri-vip-diamond-fill"></i>  </span>
                                <span class="menu-title">Доп.услуги</span>
                                <span class="menu-suffix"> <span class="badge secondary"></span>  </span>
                            </a>
                        </li>
                        ...
                        <li class="menu-item sub-menu">
                            <a href="#">
                                ...
                                <span class="menu-suffix"> <span class="badge secondary"></span>Скоро</span>
                            </a>
                            <div class="sub-menu-list">
                                <ul>
                                    <li class="menu-item">
                                        <a href="#" class="click" value="userSettings">
                                            <span class="menu-title">Общие настройки</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="#" class="click" value="userProfile">
                                            <span class="menu-title">Настройки профиля</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" value="userCompany">
                                        <a href="#">
                                            <span class="menu-title">Настройки компании</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="sidebar-footer">
                <div class="footer-box" style="display: none;">
                    ...
                    <div style="padding: 0 10px">
                        <span style="display: block; margin-bottom: 10px" >Fulfillment-pro инструкция по работе</span>
...
<script src="/local/lib/js/popper.js"></script>
...
<script defer src="/local/components/dashboard/main_app/templates/fulfillment/script_web.js?1238"></script>
<script>
    <?= $arResult['chatBuy']?>
</script>