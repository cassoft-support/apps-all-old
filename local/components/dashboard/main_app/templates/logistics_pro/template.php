...
<div class="main-block" id="workarea">
    <div class="input-block">
        ...
        <input type="text" id="apps" name="apps" hidden value='logistics_pro'>
            ...
            <ul id="menu">
                ...
                <?php
                  //  if ($arResult['admin'] === 'Y') { ?>
                        ...
                        <li><a href="#" class="click" value="applications">Запросы</a></li>
                        <li><a href="#">Справочники</a>
                            <ul>
                                <li><a href="#" class="click" value="cars">Автомобили</a></li>
                            </ul>
                        </li>
                        <li><a href="#">Отчеты</a>
                            <ul>
                                <li><a href="#" class="click" value="reportApplication">Отчет по Заявкам</a></li>
                                <li><a href="#" class="click" value="reportInvoiceOut">Счёта поставщиков</a></li>
                            </ul>
                        </li>
                    <?php
                  //  } ?>
...
<script defer src="/local/components/dashboard/main_app/templates/logistics_pro/script.js?1238"></script>
