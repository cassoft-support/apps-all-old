...
<link rel="stylesheet" href="/local/components/dashboard/main_app/templates/gas_mix/menuMob.css"/>
...
<div class="main-block" id="workarea">
    <div class="input-block">
       ...
       <!-- <input type="text" id="UserAut" name="UserAut" hidden value='<?= htmlspecialchars($arResult['UserAut']) ?>'>-->
        <input type="text" id="apps" name="apps" hidden value='gas_mix'>
...
<script defer src="/local/components/dashboard/main_app/templates/gas_mix/script.js?1238"></script>
