...
<div class="layout has-sidebar fixed-sidebar fixed-header">
    <div class="input-block">
        ...
        <input type="text" id="appCode"  hidden value='gas_mix'>
            ...
            <div class="sidebar-content">
                <nav class="menu open-current-submenu">
                    <ul>
                       ...
                       <li class="menu-item">
                            <a href="#" class="click" value="charts">
...
<script defer src="/local/components/dashboard/main_app/templates/gas_mix/script.js?0111"></script>
<script>
    (function(w,d,u){
