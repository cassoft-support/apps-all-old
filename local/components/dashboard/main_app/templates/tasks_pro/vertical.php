...
<div class="layout has-sidebar fixed-sidebar fixed-header">
    <div class="input-block">
        ...
        <input type="hidden" id="user_id" name="user_id" hidden value=''>
        <input type="hidden" id="appCode"  hidden value='<?= $arResult['app'] ?>'>
    ...
    <aside id="sidebar" class="sidebar break-point-sm has-bg-image">
        ...
        <div class="sidebar-layout">
            <div class="sidebar-header">
                <div class="block-flex-row --nowrap --align-end --justify-start">
                    <div class="pro-sidebar-logo_img">
                        <img src="/local/images/tasks-pro/logo.png" alt="Задачи pro" />
                    </div>
                    <div class="block-flex-row --nowrap" style="display: none;">
            ...
            <div class="sidebar-content">
                <nav class="menu open-current-submenu">
                    <ul>
                        ...
                        <li class="menu-item ">
                            <a href="#" class="click" value="tasks">
                        ...
                        <li class="menu-item ">
                            <a href="#" class="click" value="report">
                        ...
                        <li class="menu-item sub-menu">
                            ...
                            <div class="sub-menu-list">
                                <ul>
                                    ...
                                    <li class="menu-item">
                                        <a href="#" class="click" value="guide">
...
<script defer src="/local/components/dashboard/main_app/templates/tasks_pro/script.js?1238"></script>
<script>
    <?= $arResult['chatBuy']?>
