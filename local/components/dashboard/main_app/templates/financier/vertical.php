...
<div class="layout has-sidebar fixed-sidebar fixed-header">
    <div class="input-block">
        ...
        <input type="text" id="appCode"  hidden value='financier'>
            ...
            <div class="sidebar-content">
                <nav class="menu open-current-submenu">
                    <ul>
                        ...
                        <li class="menu-item ">
                            <a href="#" class="click" value="balance">
                                <span class="menu-icon"> <i class="ri-user-search-fill"></i> </span>
                                <span class="menu-title">Доходы и расходы</span>
                                <span class="menu-suffix"> <span class="badge primary">Hot</span> </span>
                            </a>
                        </li>
                        <li class="menu-item ">
                            <a href="#" class="click" value="items_debit_credit">
                                <span class="menu-icon"> <i class="ri-user-search-fill"></i> </span>
                                <span class="menu-title">Статьи доходов-расходов</span>
                                <span class="menu-suffix"> <span class="badge primary">Hot</span> </span>
                            </a>
                        </li>
                        <li class="menu-item ">
                            <a href="#" class="click" value="decode_deb_cred">
                                <span class="menu-icon"> <i class="ri-user-search-fill"></i> </span>
                                <span class="menu-title">Расшифровка доходов-расходов</span>
                                <span class="menu-suffix"> <span class="badge primary">Hot</span> </span>
                            </a>
                        </li><li class="menu-item ">
                            <a href="#" class="click" value="personal_account">
                                <span class="menu-icon"> <i class="ri-user-search-fill"></i> </span>
                                <span class="menu-title">Лицевые счета сотрудников</span>
                                <span class="menu-suffix"> <span class="badge primary">Hot</span> </span>
                            </a>
                        </li>
                        <li class="menu-item ">
...
<script defer src="/local/components/dashboard/main_app/templates/financier/script.js?1238"></script>
<script>
    <?= $arResult['chatBuy']?>
</script>