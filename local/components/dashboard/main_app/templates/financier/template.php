...
<div class="main-block" id="workarea">
    <div class="input-block">
        ...
        <input type="text" id="appCode"  hidden value='hr_pro'>
            ...
            <ul id="menu">
                ...
                <?php
                  //  if ($arResult['admin'] === 'Y') { ?>
                        ...
                        <li><a href="#" class="click" value="candidates">Кандидаты</a></li>
                        <li><a href="#" class="click" value="vacancy">Вакансии</a></li>
...
<!--                                <li><a href="#" class="click" value="update">Update</a></li>-->
                        ...
                        <?php
                                ...
                                <li><a href="#" class="click" value="stageCandidates">Стадии кандидатов</a></li>
