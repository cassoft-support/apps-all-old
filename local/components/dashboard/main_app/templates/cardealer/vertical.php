...
<div class="layout has-sidebar fixed-sidebar fixed-header">
    <div class="input-block">
        ...
        <input type="text" id="appCode"  hidden value='cardealer'>
        <input type="text" id="user_id" name="user_id" hidden value='<?php echo $arResult['user_id'] ?>'>
        <input type="text" id="adminId" name="adminId" hidden value='<?php echo $arResult['adminId'] ?>'>
            ...
            <div class="sidebar-content">
                <nav class="menu open-current-submenu">
                    <ul>
                        ...
                        <li class="menu-item">
                            <a href="#" class="click" value="transferStat">
                                <span class="menu-icon"><i class="ri-user-heart-fill"></i>  </span>
                                <span class="menu-title">Распределение Лидо/Сделок</span>
                            </a>
                        </li>
                        ...
                        <li class="menu-item sub-menu">
                            ...
                            <a href="#">
                                <span class="menu-icon"> <i class="ri-settings-4-line"></i> </span>
                                <span class="menu-title">Распределени Лидов/Сделок</span>
                            </a>
                            <div class="sub-menu-list">
                                <ul>
                                    <li class="menu-item">
                                        <a href="#" class="click" value="transferGroup">
                                            <span class="menu-title">Групировка пользователей</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="#" class="click" value="algorithm">
                                            <span class="menu-title">Алгоритмы распределения</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <a href="#">
                                <span class="menu-icon"> <i class="ri-settings-4-line"></i> </span>
                                <span class="menu-title">Настройки HR</span>
                            </a>
                            <div class="sub-menu-list">
                                <ul>
                                    <li class="menu-item">
                        ...
                        <?php
                        if ($arResult['userFIO'] === 'Черкасов' || $arResult['userFIO'] === 'Support') {
                            ?>
                            <li class="menu-item">
...
<script src="/local/components/support/cardealer/js/support.js?1607"></script>
<script defer src="/local/components/dashboard/main_app/js/vertical_menu.js?1238"></script>
<script defer src="/local/components/dashboard/main_app/templates/cardealer/script.js?1238"></script>
<script>
    (function(w,d,u){
