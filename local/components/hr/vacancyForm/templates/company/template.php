...
//$debug->console($arResult['link'], 'arResultLINK');
//d($arResult["scanDoc"]);
?>
<style>
   body{
...
<div class="" id="workarea">
    ...
    <input type="text" id ="company_id" value="<?= $arResult['company_id']?>" style="display: none;">
...
<script defer type="text/javascript" src="/local/components/scanDoc/base/templates/company/script.js?1548"></script>
