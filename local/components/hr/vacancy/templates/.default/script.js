...
function editRecord(value) {
    ...
    BX24.init(function(){
        ...
        $.ajax({
            type: "POST",
            url: "/local/components/hr/vacancy/templates/.default/ajax/creat.php",
            data: {
                value: value,
                auth:auth,
                app:$('#appCode').val()
...
$('#loadingHH').on('click', function() {
    ...
    BX24.init(function(){
        ...
        $.ajax({
            type: "POST",
            url: "/local/components/hr/vacancy/templates/.default/ajax/loadingHH.php",
            data: {
                auth:auth,
                app:$('#appCode').val(),
                user_id:$('#user_id').val(),
