<?php
    ...
    require_once($_SERVER["DOCUMENT_ROOT"] . "/local/components/scanDoc/base/templates/contact/save_function.php");
...
if(!empty($clientApp) && $_POST['app']) {
    ...
    $contactUp = $auth->core->call("crm.contact.update", [ 'id' => $_POST['contact_id'], 'fields' => $paramsUp])->getResponseData()->getResult()->getResultData();
    file_put_contents($file_log, print_r($contactUp, true), FILE_APPEND);
