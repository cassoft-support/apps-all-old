...
$('#create').on('click', function() {
    $.ajax({
        type: 'POST',
        url: "/local/components/settings/favouritesStage/ajax/create.php",
        data: {
            type: 'addRecord',
        },
        dataType: "html",
...
$('#addRecord').on('click', function() {
    ...
    $.ajax({
        type: 'POST',
        url: "/local/components/settings/favouritesStage/ajax/addRecord.php",
        data: map,
        dataType: "html",
        success: function(response) {
            console.log(response)
...
function deleteRecord(id) {
    ...
    if (result) {
        ...
        $.ajax({
            type: 'POST',
            url: "/local/components/settings/favouritesStage/ajax/delete.php",
            data: {
                id: id,
                UserAutPlan: UserAut,
            },
...
$('#save').on('click', function() {
    ...
    elements.map(function() {
        ...
        .get()
    $.ajax({
        url: '/local/components/settings/favouritesStage/ajax/save.php',
        type: 'POST',
        data: map,
        dataType: "html",
        success: function(response) {
...
function editRecord(value) {
    ...
    $.ajax({
        url: "/local/components/settings/favouritesStage/ajax/edit.php",
        data: {
            value: value,
            planType: planTypeQ,
        },
