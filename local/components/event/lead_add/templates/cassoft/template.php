...
<head>
    ...
    <link rel="stylesheet" href="/local/components/install/base/templates/logistic/style.css">
</head>
<style>
    .forma-install {
        display: flex;
...
<div class="forma-install">
    ...
    <div class="">Дождитесь окончания процесса.</h3>
        ...
        <br>
        <div class="btn_block">
            <button class="form-small-button-blue" id="finishInstall">Установить</button>
        </div>
...
<script src="/local/components/install/base/templates/logistic/script.js"></script>
