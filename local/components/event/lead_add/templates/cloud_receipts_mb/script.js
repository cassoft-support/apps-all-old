...
$(document).ready(function () {
    ...
    $(document).on('click', '#install', function () {
        ...
        //  console.log(data)
        post(
            '/local/components/install/base/templates/cloud_receipts_mb/entityInstall/installPaySystem.php',
            data,
            1
            ...
            changeProgressBar(1)
            return post(
                '/local/components/install/base/templates/cloud_receipts_mb/entityInstall/installSetup.php',
                data,
                2
            )
        }).then(function (result) {
            ...
            changeProgressBar(2)
            return post(
                '/local/components/install/base/templates/cloud_receipts_mb/entityInstall/installTabs.php',
                data,
                3
            )
        }).then(function (result) {
            ...
            changeProgressBar(3)
            return post(
                '/local/components/install/base/templates/cloud_receipts_mb/entityInstall/installFinish.php',
                data,
                4
            )
        }).then(function (result) {
