<?php
   ...
   // require($_SERVER['DOCUMENT_ROOT'] . '/local/lib/bitrixAuth/CSrest.php');
    //require($_SERVER['DOCUMENT_ROOT'] . '/local/lib/classes/gf.php');
    $date = date("d.m.YTH:i");
                  ...
                  <form id="scanForm" class="block-flex-columns">
                                <div class="block-flex-row --justify-start --nowrap">
                                                        <div class="cs-input-container" >
                                                            ...
                                                            <span for="dropzone" class="cs-input-label cs-input-label-select" style="min-width: 350px!important;">Добавьте скан документа</span>
...
<script defer type="text/javascript" src="/local/components/scanDoc/base/templates/smart/script.js?19071230"></script>
