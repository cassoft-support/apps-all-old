...
<div class="" id="workarea">
    ...
    <input type="text" id ="contact_id" value="<?= $arResult['contact_id']?>" style="display: none;">
...
<script defer type="text/javascript" src="/local/components/scanDoc/base/templates/contact/script.js?1532"></script>
