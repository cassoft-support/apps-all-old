...
$log = __DIR__ . "/logMessageAddAuto.txt";
...
if ($arParams['app'] && $arParams['auth']['member_id']) {
    ...
    $chatEntityId = explode('|', $arParams['data']['PARAMS']['CHAT_ENTITY_ID']);
    $params = [
        'ENTITY' => 'setup_messager',
        'sort' => [],
        'filter' => [
            'PROPERTY_CS_LINE'=>$chatEntityId[1]
        ],
    ];
...
//p($dataMes , "dataMes", $log);
    ...
    $ch = curl_init('https://public-api.cian.ru/v1/get-chat?chatId=' . $chatEntityId[2]);
