<?
    ...
    // d($userCur);
    // $token = 'f44d3cb9238b4aa2941216854cac56f8'; //a3d9943e3b454bddbdf630e4027c95f2 //b374bb775ba24396afa2a7d68242bdfa
...
d($elApp);
    ...
    foreach ($auth->batch->getTraversableListEntity('entity.item.get', 'payment_terms', [], $filter, 6000) as $val) {
        $i++;
        /*  usleep(50000);
    ...
    foreach ($auth->batch->getTraversableListEntity('entity.item.get', 'cargo', [], $filter, 6000) as $val) {
        $y++;
    ...
    foreach ($auth->batch->getTraversableListEntity('entity.item.get', 'application', [], $filter, 6000) as $val) {
