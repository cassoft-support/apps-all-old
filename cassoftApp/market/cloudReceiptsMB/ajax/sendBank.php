...
$postData = json_encode([
    "Operations"=> [
    "42f17e73-04f2-4641-9008-b280018980b6",
],
//"SignBase64"=> base64_encode($_POST['signatureBase64']),
"SignBase64"=> $_POST['signatureBase64'],
]);
