...
async function handleConnectProfile() {
  ...
  if (selectedProfile && selectedProfile.id) {
    ...
    //  const result = await wappGet(`${typeUrl}/sync/get/status?profile_id=${selectedProfile.id}`)
...
//
//       const resImConnectorWidget =  imConnectorWidget.data()
// console.log(resImConnectorWidget, 'resImConnectorWidget')
